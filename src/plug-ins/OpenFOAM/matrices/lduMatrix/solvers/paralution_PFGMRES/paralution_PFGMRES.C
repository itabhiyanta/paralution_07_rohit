...
#include "paralution_PFGMRES.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(paralution_PFGMRES, 0);

    lduMatrix::solver::addsymMatrixConstructorToTable<paralution_PFGMRES>
        addparalution_PFGMRESSymMatrixConstructorToTable_;

    lduMatrix::solver::addasymMatrixConstructorToTable<paralution_PFGMRES>
        addparalution_PFGMRESAsymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::paralution_PFGMRES::paralution_PFGMRES
(
